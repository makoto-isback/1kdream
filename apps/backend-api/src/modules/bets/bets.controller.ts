...
export class BetsController {
  ...
  @Throttle({ bets: { limit: 200, ttl: 60000 } }) // 200 bet placements per minute (allows 10+ bets at once + refetches)
  ...
  @Get('my')
  @UseGuards(JwtAuthGuard)
  @Throttle({ default: { limit: 500, ttl: 60000 } }) // 500 requests per minute for bet history
